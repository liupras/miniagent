...
class Settings(BaseSettings):
    ...
    password_min_length: int = Field(default=8, ge=1, description="Shortest password length")
    ...
    login_max_failed_attempts: int = Field(default=5, ge=1, description="The maximum number of failed login attempts will result in your account being locked.")
    login_lock_duration_minutes: int = Field(default=10, ge=1, description="The account will be locked for a specified period of time; it will be automatically unlocked after this period.")
