...
@router.get("", response_model=ApiResponse, summary="Paginated agent list")
async def list_agents(
    ...
    result: PageResult = await svc.list_agents(params)
    return ApiResponse(data=result)


@router.get("/{agent_id}", response_model=ApiResponse, summary="Get agent by id")
async def get_agent(
    agent_id: int,
    svc: AgentService = Depends(get_agent_service),
):
...
@router.put("/{agent_id}", response_model=ApiResponse, summary="Update agent")
...
@router.delete("/{agent_id}", response_model=ApiResponse, summary="Delete agent")
...
@router.delete("", response_model=ApiResponse, summary="Batch delete agents")
